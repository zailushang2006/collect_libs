...
- [Jiagu](https://github.com/ownthink/Jiagu) Jiagu自然语言处理工具
...
- [chinese-word2vec](https://github.com/to-shimo/chinese-word2vec) word2vec/glove/swivel binary file on chinese corpus
...
- [NLPCC2016KBQA](https://github.com/huangxiangzhou/NLPCC2016KBQA) KBQA based on the NLPCC2016 dataset
...
- [Z_knowledge_graph](https://github.com/Pelhans/Z_knowledge_graph) 从零开始的知识图谱
- [YAGO](https://github.com/yago-naga/yago3) YAGO
...
- [DeepDiveChineseApps](https://github.com/SongRb/DeepDiveChineseApps) DeepDive Tutorial with Chinese Support
- [DeepDive_Chinese](https://github.com/qiangsiwei/DeepDive_Chinese) DeepDive 中文配置
...
- [newspaper](https://github.com/codelucas/newspaper) Article scraping & curation
...
- [dive-into-machine-learning](https://github.com/dive-into-machine-learning/dive-into-machine-learning) machine learning
...
- [PyTorch Tutorials](https://github.com/pytorch/tutorials) 中文自然语言处理 语料/数据集
- [book-of-qna-code](https://github.com/l11x0m7/book-of-qna-code) 《智能问答与深度学习》随书附带源码
- [DeepNLP-models-Pytorch](https://github.com/DSKSD/DeepNLP-models-Pytorch) Pytorch implementations of various Deep NLP models


## 语料库
- [nlp_chinese_corpus](https://github.com/brightmart/nlp_chinese_corpus) 大规模中文自然语言处理语料
- [ChineseNlpCorpus](https://github.com/SophonPlus/ChineseNlpCorpus) 大规模中文自然语言处理语料
...
- [openie](https://github.com/knowitall/openie) Quality information extraction at web scale.
...
- [FoolNLTK](https://github.com/rockyzhengwu/FoolNLTK) A Chinese word processing toolkit
- [seq2seq-attn](https://github.com/harvardnlp/seq2seq-attn) Sequence-to-sequence model with LSTM encoder/decoders and attention
...
## 其他
- [quepy](https://github.com/machinalis/quepy) transform natural language questions to queries in a database query language. 
- [pythonnet](https://github.com/pythonnet/pythonnet) Calling .NET code from Python
- [pythonnet](https://github.com/pythonnet/pythonnet) Calling .NET code from Python
- [prince](https://github.com/MaxHalford/prince) Python factor analysis library (PCA, CA, MCA, MFA, FAMD)
- [factor_analyzer](https://github.com/EducationalTestingService/factor_analyzer) Python client library for Google Maps API Web Services
- [hosts](https://github.com/googlehosts/hosts) GoogleHosts
